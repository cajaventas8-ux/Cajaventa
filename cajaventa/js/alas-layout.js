...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const menuItems = [
    { href: "/views/dashboard-Acuses.html", icon: "fa-chart-pie", label: "Dashboard resumen", group: "Principal" },
    { href: "/views/acuses.html", icon: "fa-file-signature", label: "Acuses", group: "Operativa", badgeTarget: "total", badgeVariant: "count" },
    { href: "/views/acuses.html?estado=pendiente", icon: "fa-clock", label: "Pendientes", group: "Operativa", badgeTarget: "pendientes", badgeVariant: "badge", isActive: page === "acuses.html" && estado === "pendiente" },
    { href: "/views/dashboard-Acuses.html", icon: "fa-history", label: "Historial y calendario", group: "Operativa" }
  ];
    ...
    <div class="app-shell">
      <aside class="sidebar" role="complementary">
        <div class="sidebar__header">
          <a href="/views/dashboard-Acuses.html" class="sidebar__brand" aria-label="ALAS">
